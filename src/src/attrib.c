...
const struct innate {
...
#else
		     {  10, &(HSearching), "“´Ž@—Í‚ª‰s‚­‚È‚Á‚½", "“´Ž@—Í‚ª“Ý‚­‚È‚Á‚½" },
		     {	 0, 0, 0, 0 } },
#endif
...
#else
		     {   7, &(HFast), "‘f‘‚­‚È‚Á‚½", "’x‚­‚È‚Á‚½" },
		     {  15, &(HStealth), "‰B–§‚É“®‚¯‚é‚æ‚¤‚É‚È‚Á‚½", "‰B–§s“®‚ª‚Å‚«‚È‚­‚È‚Á‚½" },
#endif
		     {	 0, 0, 0, 0 } },
...
#else
		     {  13, &(HCold_resistance), "’g‚©‚­‚È‚Á‚½", "—Á‚µ‚­‚È‚Á‚Ä‚«‚½"},
#endif
		     {   0, 0, 0, 0 } },
...
#else
		     {  13, &(HFire_resistance), "—Á‚µ‚­‚È‚Á‚½", "’g‚©‚­‚È‚Á‚Ä‚«‚½" },
#endif
		     {   0, 0, 0, 0 } },
	...
	mon_abil[] = { {   1, &(HFast), "", "" },
		     ...
		     {   5, &(HStealth), "‰B–§‚É“®‚¯‚é‚æ‚¤‚É‚È‚Á‚½", "‰B–§s“®‚ª‚Å‚«‚È‚­‚È‚Á‚½" },
		     {   7, &(HWarning), "•qŠ´‚É‚È‚Á‚½", "“ÝŠ´‚É‚È‚Á‚½" },
		     {   9, &(HSearching), "“´Ž@—Í‚ª‰s‚­‚È‚Á‚½", "“´Ž@—Í‚ª“Ý‚­‚È‚Á‚½" },
#endif
#if 0
...
#else
		     {   3, &(HUndead_warning), "•qŠ´‚É‚È‚Á‚½", "“ÝŠ´‚É‚È‚Á‚½" },
#endif
		     {   0, 0, 0, 0 } },
	...
	pri_abil[] = { {	15, &(HWarning), "•qŠ´‚É‚È‚Á‚½", "“ÝŠ´‚É‚È‚Á‚½" },
		     {  20, &(HFire_resistance), "—â‚½‚­‚È‚Á‚½", "’g‚©‚­‚È‚Á‚Ä‚«‚½" },
#endif
		     {	 0, 0, 0, 0 } },
	...
	ran_abil[] = { {   1, &(HSearching), "", "" },
		     ...
		     {	 7, &(HStealth), "stealthy", "" },
#else
		     {	 7, &(HStealth), "‰B–§‚É“®‚¯‚é‚æ‚¤‚É‚È‚Á‚½", "‰B–§s“®‚ª‚Å‚«‚È‚­‚È‚Á‚½" },
#endif
		     {	15, &(HSee_invisible), "", "" },
		     {	 0, 0, 0, 0 } },
...
#else
	tou_abil[] = { {	10, &(HSearching), "“´Ž@—Í‚ª‰s‚­‚È‚Á‚½", "“´Ž@—Í‚ª“Ý‚­‚È‚Á‚½" },
...
#else
		     {   7, &(HFast), "‘f‘‚­‚È‚Á‚½", "’x‚­‚È‚Á‚½" },
		     {   9, &(HPoison_resistance), "–Æ‰u—Í‚ð“¾‚½", "–Æ‰u—Í‚ðŽ¸‚Á‚½" },
#endif
		     {   0, 0, 0, 0 } },
...
#else
		     {   7, &(HFast),  "‘f‘‚­‚È‚Á‚½", "’x‚­‚È‚Á‚½" },
		     {  15, &(HSwimming), "‰j‚°‚é‚æ‚¤‚É‚È‚Á‚½","…‚ª•|‚­‚È‚Á‚½" },
#endif
		     {   0, 0, 0, 0 } },
#endif
	...
	wiz_abil[] = { {	15, &(HWarning), "sensitive", "" },
		     {  17, &(HTeleport_control), "controlled","uncontrolled" },
#else
	wiz_abil[] = { {	15, &(HWarning), "’mŠo—Í‚ð“¾‚½", "’mŠo—Í‚ðŽ¸‚Á‚½" },
		     {  17, &(HTeleport_control), "§Œä—Í‚ð“¾‚½","§Œä—Í‚ðŽ¸‚Á‚½" },
#endif
		     {	 0, 0, 0, 0 } },
...
#else
		       {   9, &(HPolymorph_control), "Žp‚ð‘I‚×‚é‚æ‚¤‚É‚È‚Á‚½", "‘I‚×‚È‚­‚È‚Á‚½" },
#endif
		       {   0, 0, 0, 0 } },
...
#else
	gno_abil[] = { {   5, &(HStealth), "‰B–§‚É“®‚¯‚é‚æ‚¤‚É‚È‚Á‚½", "‰B–§s“®‚ª‚Å‚«‚È‚­‚È‚Á‚½" },
#endif
/*		     {   9, &(HFast), "quick", "slow" },
...
#else
				    "”½ŽË_Œo‚ðŽg‚Á‚Ä‚¢‚½‚Éˆá‚¢‚È‚¢D" :
				    "Å‹ß”½ŽË_Œo‚ðŽg‚Á‚Ä‚È‚©‚Á‚½‚Éˆá‚¢‚È‚¢D");
#endif
				break;
...
#else
				    "Œ’N“I‚È¶Šˆ‚ð‚µ‚Ä‚¢‚½‚Éˆá‚¢‚È‚¢D" :
				    "Œ’NŠÇ—‚ð‘Ó‚Á‚Ä‚¢‚½‚Éˆá‚¢‚È‚¢D");
#endif
				break;
		    }
		}
...
*/
				You("%s‚æ‚¤‚È‹C‚ª‚µ‚½I", abil->gainstr);
			}
...
*/
				You("%s‚æ‚¤‚È‹C‚ª‚µ‚½I", abil->losestr);
/*JP 
**	‚±‚ÌðŒ‚Í–ž‚³‚È‚¢‚Í‚¸D
*/
