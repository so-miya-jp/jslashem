...
#else
static const char *levitate[4]	= { "ïÇÇ©Ç—", "ïÇÇ¢Çƒ", "ÇÆÇÁÇ¬Ç´", "ÇÆÇÁÇ¬Ç¢ÇΩ" };
static const char *flys[4]	= { "îÚÇ—", "îÚÇÒÇ≈", "Ç”ÇÁÇ¬Ç´", "Ç”ÇÁÇ¬Ç¢ÇΩ" };
static const char *flyl[4]	= { "îÚÇ—", "îÚÇÒÇ≈", "ÇÊÇÎÇﬂÇ´", "ÇÊÇÎÇﬂÇ¢ÇΩ" };
static const char *slither[4]	= { "ääÇË", "ääÇ¡Çƒ", "ÇÃÇΩÇ§Çø", "ÇÃÇΩÇ§Ç¡ÇΩ" };
static const char *ooze[4]	= { "Ç…Ç∂Ç›", "îáÇ¡Çƒ", "êkÇ¶", "êkÇ¶ÇΩ" };
static const char *immobile[4]	= { "Ç≠ÇÀÇË", "Ç≠ÇÀÇ¡Çƒ", "ÇÃÇΩÇ§Çø", "ÇÃÇΩÇ§Ç¡ÇΩ" };
static const char *crawl[4]	= { "îáÇ¢Ç∏ÇË", "îáÇ¢Ç∏Ç¡Çƒ", "ÇΩÇ∂ÇÎÇ¨", "ÇΩÇ∂ÇÎÇ¢Çæ" };
#endif
...
const char *def;
{
	...
	int capitalize = (!def || !*def ||
		strcmp(eos((char *)def)-2, "Ç≈") ||
		strcmp(eos((char *)def)-2, "Çƒ"));
#endif
...
#else
	int capitalize = (strcmp(eos((char *)def)-2, "ÇΩ")) ? 3 : 2;
#endif
...
#if 1 /*JP*/
static const char *levitate2	= "ïÇÇ´èoÇΩ";
static const char *fly2		= "îÚÇ—èoÇΩ";
static const char *slither2	= "ääÇËèoÇΩ";
static const char *ooze2	= "Ç…Ç∂Ç›èoÇΩ";
static const char *crawl2	= "ÇÕÇ¢Ç∏ÇËèoÇΩ";
...
*/
	what = (mattk->aatyp == AT_HUGS) ? "ä€èƒÇØÇ…Ç»Ç¡ÇΩ" : "âŒÇæÇÈÇ‹Ç…Ç»Ç¡ÇΩ";
	break;
    }
    return what;
}
