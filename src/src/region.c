...
*/
	    pline("%s‚ÍŽp‚ð•Ï‚¦‚½I", Monnam(cthulhu));
    }
    return ret;
}
...
*/
	    pline("%s‚ª‚ ‚È‚½‚Ì%s‚ðŽÜ‚¢‚½I", Something, body_part(LUNG));
/*JP
...
*/
	    losehp(rnd(dam) + 5, "“ÅƒKƒX‚ð‹z‚¢ž‚ñ‚Å", KILLED_BY_AN);
	    return FALSE;
	} else {
/*JP
	    You("cough!");
