...
*/
	{"ÉyÉbÉgêÍñÂìX", FOOD_CLASS, 4, D_SHOP,{
#ifdef STEED
...
*/
	{"ó‚ìÄêHïiìX", FOOD_CLASS, 4, D_SHOP,
		{{90, -ICE_BOX}, {10, -TIN},
...
*/
	{"ãMèdñ{êÍñÂìX", SPBOOK_CLASS, 4, D_SHOP,
