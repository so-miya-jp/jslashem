/*
  $Id: winGTK.h,v 1.7 2005/04/20 14:15:23 so-miya Exp $
 */
...
#if 1 /*JP*/
extern void GTK_j_text_buffer_insert(GtkTextBuffer *buffer, GtkTextIter *iter, const gchar *text, gint len);
extern void GTK_j_text_buffer_insert_at_cursor(GtkTextBuffer *buffer, const gchar *text, gint len);
extern void GTK_j_text_buffer_insert_with_tags_by_name(GtkTextBuffer *t, GtkTextIter *iter, const gchar *buf, gint len, const gchar *tag);
#if !GTK_CHECK_VERSION(2,0,0)
extern void GTK_j_text_insert(GtkText *text, GdkFont *font, GdkColor *fore, GdkColor *back, const gchar *chars, gint length);
#endif
extern void GTK_j_label_set_text(GtkLabel *label, const char *str);
extern void GTK_j_frame_set_label(GtkFrame *frame, const char *label);
extern void GTK_j_entry_set_text(GtkEntry *entry, const gchar *text);
extern void GTK_j_window_set_title(GtkWindow *parent, const gchar *label);
extern void GTK_j_notebook_set_tab_label_text(GtkNotebook *notebook, GtkWidget *child, const gchar *tab_text);
extern GtkWidget* GTK_j_frame_new(const gchar *label);
extern GtkWidget* GTK_j_label_new(const gchar *str);
extern GtkWidget* GTK_j_label_new_with_mnemonic(const gchar *label);
extern GtkWidget* GTK_j_button_new_with_label(const gchar *label);
extern GtkWidget* GTK_j_button_new_with_mnemonic(const gchar *label);
extern GtkWidget* GTK_j_check_button_new_with_label(const gchar *label);
extern GtkWidget* GTK_j_check_button_new_with_mnemonic(const gchar *label);
extern GtkWidget* GTK_j_radio_button_new_with_label(GSList *group, const gchar *label);
extern GtkWidget* GTK_j_radio_button_new_with_mnemonic(GSList *group, const gchar *label);
extern GtkWidget* GTK_j_menu_item_new_with_label(const gchar *label);
extern GtkWidget* GTK_j_menu_item_new_with_mnemonic(const gchar *label);
extern GtkWidget* GTK_j_file_selection_new(const gchar *title);
#endif
