...
static struct X_status_value shown_stats[NUM_STATS] = {
    ...
    { "重量",		SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },
    { "最大重量",	SV_VALUE, (Widget) 0, -1, 0, FALSE, FALSE },	/*20*/

    { "",		SV_NAME,  (Widget) 0, -1, 0, FALSE, TRUE }, /* hunger*/
    { "　混乱　",	SV_NAME,  (Widget) 0,  0, 0, FALSE, TRUE },
    { "　病気　",	SV_NAME,  (Widget) 0,  0, 0, FALSE, TRUE },
    { "　盲目　",	SV_NAME,  (Widget) 0,  0, 0, FALSE, TRUE },
    { "　眩暈　",	SV_NAME,  (Widget) 0,  0, 0, FALSE, TRUE },	/*25*/
...
/*JP
		Strcat(buf, mname);
*/
		Strcat(buf, jtrns_mon_gen(mname, flags.female));
	    } else
