/* $Id: callback.c,v 1.4 2005/05/12 14:45:27 so-miya Exp $ */
...
#else
	choices.roles[i].male = roles[i].jname.m;
	choices.roles[i].female = roles[i].jname.f ? roles[i].jname.f : "";
#endif
    }
