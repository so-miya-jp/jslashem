/*
**
**	$Id: jtrns.c,v 1.5 2008/05/23 16:17:20 so-miya Exp $
**
*/
     ...
     int female;
{
	...
	if(!strcmp(name, "werejackal") || !strcmp(name, "Werejackal"))
	  ...
	  return "ねずみ女";
	else if(!strcmp(name, "werepanther") || !strcmp(name, "Werepanther"))
	  return "豹女";
	else if(!strcmp(name, "weretiger") || !strcmp(name, "Weretiger"))
	  return "虎女";
	else if(!strcmp(name, "werespider") || !strcmp(name, "Werespider"))
	  return "蜘蛛女";
	else if(!strcmp(name, "weresnake") || !strcmp(name, "Weresnake"))
	  return "蛇女";
    } else {
	if(!strcmp(name, "werejackal") || !strcmp(name, "Werejackal"))
	  return "ジャッカル男";
