...
goto warn3long
:long3a
echo "Copying ..\..\doc\jguidebook.txt -> ..\..\doc\jguidebo.txt"
...
goto long3ok
:long3b
echo "Copying ..\..\doc\jguide~1.txt -> ..\..\doc\jguidebo.txt"
copy ..\..\doc\jguide~1.txt ..\..\doc\jguidebo.txt
if exist ..\..\doc\jguidebo.old del /Q ..\..\doc\jguidebo.old
ren ..\..\doc\jguide~1.txt jguidebo.old
goto long3ok
:warn3long
echo "Warning - There is no NetHack Guidebook (..\..\doc\jguidebo.txt)"
echo "          included in your distribution.  Build will proceed anyway."
:long3ok

if exist ..\..\japanese\jpatchle.h goto long4ok
if exist ..\..\japanese\jpatchlevel.h goto long4a
if exist ..\..\japanese\jpatch~1.h goto long4b
goto err_long
:long4a
...
if exist ..\..\japanese\jpatchle.old del /Q ..\..\japanese\jpatchle.old
ren ..\..\japanese\jpatch~1.h jpatchle.old
:long4ok
