...
TILEBMP16   = $(SWINCE)\tiles.bmp

TILEUTIL32  = $(UTIL)\til2bm32.exe
TILEBMP32   = $(SWINCE)\tiles32.bmp
...
all :	$(INCL)\date.h	$(INCL)\onames.h $(INCL)\pm.h \
	...
	$(SWINCE)\slashem.ico $(SWINCE)\tiles.bmp $(SWINCE)\mnsel.bmp \
...
$(O)sp_lev.tag:  $(DAT)\bigroom.des  $(DAT)\castle.des \
	...
	$(DAT)\blkmar.des  $(DAT)\grund.des    $(DAT)\dragons.des \
	$(DAT)\giants.des  $(DAT)\guild.des \
	$(DAT)\kobold-1.des $(DAT)\kobold-2.des $(DAT)\lich.des  \
	$(DAT)\mall-1.des   $(DAT)\mall-2.des   $(DAT)\mines.des \
	$(DAT)\newmall.des  $(DAT)\nymph.des    $(DAT)\rats.des  \
	$(DAT)\sea.des      $(DAT)\spiders.des  $(DAT)\stor-1.des \
	$(DAT)\stor-2.des   $(DAT)\stor-3.des   $(DAT)\tomb.des  \
	$(DAT)\flame.des    $(DAT)\ice.des      $(DAT)\necro.des \
	$(DAT)\slayer.des   $(DAT)\yeoman.des   $(DAT)\frnknstn.des \
	$(DAT)\nightmar.des
	cd $(DAT)
	$(U)lev_comp beholder.des
	$(U)lev_comp bigroom.des
	$(U)lev_comp blkmar.des
	$(U)lev_comp castle.des
	$(U)lev_comp grund.des
	$(U)lev_comp dragons.des
	$(U)lev_comp endgame.des
	$(U)lev_comp gehennom.des
	$(U)lev_comp giants.des
	$(U)lev_comp guild.des
	$(U)lev_comp knox.des
	$(U)lev_comp kobold-1.des
	$(U)lev_comp kobold-2.des
	$(U)lev_comp lich.des
	$(U)lev_comp mall-1.des
	$(U)lev_comp mall-2.des
	$(U)lev_comp mines.des
	$(U)lev_comp medusa.des
	$(U)lev_comp mtemple.des
	$(U)lev_comp newmall.des
	$(U)lev_comp nymph.des
	$(U)lev_comp oracle.des
	$(U)lev_comp sokoban.des
	$(U)lev_comp rats.des
	$(U)lev_comp sea.des
	$(U)lev_comp spiders.des
	$(U)lev_comp stor-1.des
	$(U)lev_comp stor-2.des
	$(U)lev_comp stor-3.des
	$(U)lev_comp tomb.des
...
$(SWINCE)\slashem.ico : $(U)uudecode.exe $(SWINCE)\seico.uu 
	chdir $(SWINCE)
	..\util\uudecode.exe seico.uu
	chdir $(WINCE)
...
$(DAT)\nhshare:	$(U)dlb_main.exe $(DAT)\data $(DAT)\joracles $(OPTIONS_FILE) \
	$(DAT)\jrumors $(DAT)\jhelp $(DAT)\jhh $(DAT)\jcmdhelp \
	$(DAT)\jhistory $(DAT)\jopthelp $(DAT)\jwizhelp \
	$(DAT)\license $(DAT)\jgypsy.txt $(O)sp_lev.tag
	cd $(DAT)
	echo data >dlb.lst
	...
	echo jgypsy.txt >>dlb.lst
	echo license >>dlb.lst
	$(U)dlb_main cIf dlb.lst nhshare
	cd $(SRC)

$(DAT)\nhushare:	$(U)dlb_main.exe $(DAT)\dungeon $(DAT)\quest.dat $(O)sp_lev.tag
	echo dungeon > $(DAT)\dlb2.lst
	echo quest.dat >>$(DAT)\dlb2.lst
	cd $(DAT)
	for %%N in (*.lev) do echo %%N >>dlb2.lst
	$(U)dlb_main cvCIf $(DAT) dlb2.lst nhushare
	cd $(SRC)
...
$(WSHR)\tile.h: ../win/share/tile_t.h $(U)tilemap.exe
	$(U)tilemap.exe
...
$(DAT)\quest.dat: $(UTIL)\makedefs.exe  $(DAT)\jquest.txt
	$(U)makedefs -q
...
$(O)tech.o: tech.c $(HACK_H)

#
# from japanese
#

$(O)jlib.o:    $(PCH) $(JP)\jlib.c $(HACK_H) $(JP)\jrubdata.h
